...
export function PlayButton() {
  ...
  return (
    <div className="static sm:relative flex flex-col items-center">
      <button
        type="button"
      ...
      {showSilentSwitchHint && (
        <div className="absolute inset-x-3 top-full mt-2 z-40 w-auto max-w-[24rem] mx-auto flex items-center gap-2 rounded border border-orange-500/60 bg-zinc-950/95 px-3 py-2 text-xs text-orange-200 shadow-lg sm:inset-x-auto sm:left-1/2 sm:-translate-x-1/2 sm:w-56 sm:max-w-none sm:mx-0">
