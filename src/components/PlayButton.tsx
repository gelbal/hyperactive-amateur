  ...
  return (
    <div className="static lg:relative flex flex-col items-center">
      ...
      {showSilentSwitchHint && (
        <div className="absolute inset-x-3 top-full mt-2 z-40 w-auto max-w-[24rem] mx-auto flex items-center gap-2 rounded border border-orange-500/60 bg-zinc-950/95 px-3 py-2 text-xs text-orange-200 shadow-lg lg:inset-x-auto lg:left-1/2 lg:-translate-x-1/2 lg:w-56 lg:max-w-none lg:mx-0">
