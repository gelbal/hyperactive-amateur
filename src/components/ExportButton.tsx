    ...
    <div className="static sm:relative" ref={rootRef}>
      ...
      {open && (
        <div
          ...
          className="absolute inset-x-3 top-full mt-2 z-30 w-auto max-w-[24rem] mx-auto rounded-md border border-zinc-700 bg-zinc-900 shadow-xl p-4 flex flex-col gap-3 sm:inset-x-auto sm:right-0 sm:min-w-[18rem] sm:max-w-none sm:mx-0"
        >
          {formats.length > 1 && (
