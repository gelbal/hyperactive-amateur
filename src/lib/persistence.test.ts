// ABOUTME: persistence tests — round-trip save/load via fake-indexeddb.
...
describe("persistence", () => {
  ...
  it("loadProject returns null on a malformed record", async () => {
    // Anything not matching the current shape gets treated as fresh-start.
    await saveProject(useAppStore.getState());
