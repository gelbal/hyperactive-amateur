...
// Preference order — first match per container wins. MP4 is listed before
// WebM because messaging apps (WhatsApp, iMessage, Twitter, Instagram) only
// play MP4 natively; sharing is the v1.x mobile workflow.
