# spec-v1.1.md — Hyperactive Amateur v1.1
...
Hyperactive Amateur cuts between your clips on every musical hit. If all 8 of
...
```text
Modify the Hyperactive Amateur codebase to add a `showVideo` field to the Track
type.
